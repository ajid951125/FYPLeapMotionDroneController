...
public class ble_scan_device_activity extends ListActivity {
    private static final String TAG = ble_scan_device_activity.class.getName();
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        getMenuInflater().inflate(R.menu.ble_scan_device_activity_menu, menu);
        if (!mScanning) {
    ...
    protected void onListItemClick(ListView l, View v, int position, long id) {
        ...
        final Intent intent = new Intent(this, drone_control_activity.class);
        intent.putExtra(drone_control_activity.EXTRAS_DEVICE_NAME, device.getName());
        intent.putExtra(drone_control_activity.EXTRAS_DEVICE_ADDRESS, device.getAddress());
        if (mScanning) {
    ...
    private class LeDeviceListAdapter extends BaseAdapter {
        ...
        public LeDeviceListAdapter() {
            ...
            mInflator = ble_scan_device_activity.this.getLayoutInflater();
        }
